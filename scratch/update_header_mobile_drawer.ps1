# PowerShell script to update header layout for the YogaSphere style mobile menu and drawer
...
$newHeader = @'
  ...
  <header class="sticky top-0 z-40 bg-white/95 dark:bg-darknavy/95 backdrop-blur border-b border-gray-100 dark:border-gray-800 transition-colors duration-300">
    ...
    <div id="mobile-menu" class="hidden fixed inset-0 z-50 bg-black/50 backdrop-blur-sm xl:hidden">
      <div class="absolute top-0 right-0 rtl:left-0 rtl:right-auto w-80 h-full bg-white dark:bg-darknavy p-6 shadow-2xl flex flex-col justify-between transition-transform duration-300">
        
        <div class="space-y-6">
          <!-- Drawer Header -->
          <div class="flex justify-between items-center pb-4 border-b border-gray-150 dark:border-gray-800">
            <h4 class="text-lg font-bold text-darknavy dark:text-white">Menu</h4>
            <button id="mobile-menu-close" class="text-gray-500 hover:text-magenta focus:outline-none">
              <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg>
            </button>
          </div>
          ...
          <nav class="space-y-4">
            <!-- Home Accordion -->
            <div class="space-y-2">
              <button class="w-full flex justify-between items-center py-2 text-gray-700 dark:text-gray-300 hover:text-magenta font-semibold transition" onclick="this.nextElementSibling.classList.toggle('hidden')">
                <span>Home</span>
                <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
              </button>
              <div class="pl-4 space-y-2 hidden border-l border-gray-100 dark:border-gray-800">
                <a href="index.html" class="block py-1 text-sm text-gray-500 hover:text-magenta">Home 1 - Academy Landing</a>
                <a href="home-niche.html" class="block py-1 text-sm text-gray-500 hover:text-magenta">Home 2 - Niche Urban Beat</a>
              </div>
            </div>
            ...
            <div class="space-y-2">
              ...
              <div class="pl-4 space-y-2 hidden border-l border-gray-100 dark:border-gray-800">
                <a href="schedule.html" class="block py-1 text-sm text-gray-500 hover:text-magenta">Class Schedule</a>
                <a href="gallery.html" class="block py-1 text-sm text-gray-500 hover:text-magenta">Event Gallery</a>
                <a href="pricing.html" class="block py-1 text-sm text-gray-500 hover:text-magenta">Membership Plans</a>
                <a href="blog.html" class="block py-1 text-sm text-gray-500 hover:text-magenta">Academy Blog</a>
              </div>
            </div>
        ...
        <div class="space-y-6">
          ...
          <div class="pt-4 border-t border-gray-100 dark:border-gray-800">
            <a href="login-register.html" class="block w-full text-center bg-magenta hover:bg-magenta-hover text-white py-3 rounded-xl font-bold shadow transition text-sm">Register Now</a>
          </div>

          <!-- Bottom Toggles Bar -->
          <div class="flex justify-between items-center pt-4 border-t border-gray-150 dark:border-gray-800">
            <!-- Theme Toggle Icon Button -->
            <button class="theme-toggle p-2.5 rounded-xl border border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-darknavy-light text-gray-500 dark:text-gray-400 transition">
              <svg class="theme-toggle-sun w-5 h-5 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364-6.364l-.707.707M6.343 17.657l-.707.707m12.728 0l-.707-.707M6.343 6.343l-.707-.707M12 8a4 4 0 100 8 4 4 0 000-8z"></path></svg>
              <svg class="theme-toggle-moon w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"></path></svg>
            </button>
            
            <!-- RTL/LTR Swap Icon Button -->
            <button class="rtl-toggle p-2.5 rounded-xl border border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-darknavy-light text-gray-500 dark:text-gray-400 transition">
...
Get-ChildItem -Filter *.html | ForEach-Object {
    ...
    if ($content -match $headerPattern) {
        ...
        Write-Host "Updated header mobile drawer in: $name"
    }
}
